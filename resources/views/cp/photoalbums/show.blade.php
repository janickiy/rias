            ...
            <div class="jarviswidget" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false"
                ...
                <div>
                    ...
                    <div class="widget-body no-padding">
                        ...
                        {!! Form::open(['url' => route('cp.photoalbums.upload'), 'files' => true, 'method' => 'post', 'id' => 'smart-form']) !!}

                        {!! Form::hidden('photoalbum_id', $photoalbum->id) !!}
        ...
        $(document).ready(function () {
            ...
            */
            ...
            $('#itemList').dataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{ URL::route('cp.datatable.images',['photoalbum_id' => $photoalbum->id]) }}'
                },
                columns: [
            ...
            $('#itemList').on('click', 'a.deleteRow', function () {
                ...
                swal({
                    ...
                    function (isConfirm) {
                        if (!isConfirm) return;
                        $.ajax({
                            url: '{{ URL::route('cp.images.destroy') }}',
                            type: "POST",
                            dataType: "html",
                            data: {id: rowid},
