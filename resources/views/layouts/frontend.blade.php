...
<head>
    ...
    <style>
        ...
        * {
        ...
        .title1--white, .title1--white h1 {
            color: #fff
        }

        .title1--lh-120, .title1--lh-120 h1 {
            line-height: 1.2
        }
        ...
        .menu__lines:after, .menu__lines:before {
            content: "";
            position: absolute;
            right: 0
        }
        ...
        @media (max-width: 991px) {
            ...
            .header--index:not(.header--fixed) .header__btn, .header--index:not(.header--fixed) .header__logo, .header--index:not(.header--fixed) .header__mobile-link {
                border-color: #fff
            }
            ...
            .header--index:not(.header--fixed) .header__menu .menu__open .menu__lines, .header--index:not(.header--fixed) .header__menu .menu__open .menu__lines:after, .header--index:not(.header--fixed) .header__menu .menu__open .menu__lines:before {
