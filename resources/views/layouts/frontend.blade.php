    ...
    <div class="header__top">
        <div class="container header__container">
            <div class="header__top-links">
                <a class="link header__top-link" href="{{ URL::route('frontend.converter') }}">
            ...
            <div class="header__bottom-content">
                ...
                <nav class="menu header__menu">
                    <div class="menu__content">
                        ...
                        <ul class="menu__list">
                            ...
                            <li class="menu__item menu__item--mobile">
                                <a class="menu__link" href="{{ URL::route('frontend.converter') }}">
                                    <img src="{{ url('img/icons/converter-black.svg') }}" width="10" height="12" alt="">
                                    Конвертер ед. изм.
                                </a>
                            </li>
                        </ul>
                        ...
                        <a class="btn btn--black menu__btn" href="{{ URL::route('frontend.application') }}">Заявка на расчет проекта</a>
                    </div>
        ...
        <div class="footer__content">
            ...
            <ul class="footer__menu">
                <li class="footer__menu-item">
                    <a class="link footer__menu-link" href="mailto:{{ SettingsHelper::getSetting('EMAIL') }}">{{ SettingsHelper::getSetting('EMAIL') }}</a>
                </li>
                <li class="footer__menu-item">
                    <a class="link footer__menu-link" href="tel:{{ SettingsHelper::getSetting('PHONE') }}">{{ SettingsHelper::getSetting('PHONE') }}</a>
                </li>
            </ul>
        </div>
    </div>
